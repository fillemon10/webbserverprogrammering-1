        ...
        <div class="single-blog all-published">
          <div class="row">
            <div class="col-xl-8 col-lg-8 col-md-8 section-title">
              ...
              <div class="row">
                <a class="mb-0" href="single_post.php?post-slug=<?php echo $post['slug']; ?>">
                  <h2 class="mb-0 wow fadeInLeft" data-wow-delay=".2s"><?php echo $post['title'] ?></h2>
                </a>
              </div>
              <?php if (isset($post['topic']['name'])) : ?>
                <a class="mb-0" href="<?php echo BASE_URL . '/filtered_posts.php?topic=' . $post['topic']['id'] ?>"> <span class="wow fadeInLeft" data-wow-delay=".4s"> <?php echo $post['topic']['name'] ?></span></a>
              <?php endif ?>
              <div class="mb-10 wow fadeInLeft" data-wow-delay=".6s"><?php echo htmlspecialchars_decode(shorten_string($post['body'], 40)) ?></div>
              <a href="single_post.php?post-slug=<?php echo $post['slug']; ?>" class="theme-btn readmore-btn wow fadeInUp" data-wow-delay=".4s">Read more</a>
            </div>
