      ...
      <div class="col-xl-5 col-lg-6">
        <div class="hero-content-wrapper">
          ...
          <?php if (isset($_SESSION['user']['username'])) { ?>
            ...
            <a href="<?php ROOT_PATH ?>/reviews" class="theme-btn">Latests reviews</a>
        </div>
      <?php } else { ?>
          ...
          <div class="container  box-style blog-container wow fadeInup" data-wow-delay=".2s">
            <div class="single-blog all-published blog-index-post">
              ...
              <?php if (isset($posts[$i]['topic']['name'])) : ?>
                <div class="row">
                  <a class="mb-10" href="<?php ROOT_PATH ?>/topic/<?php $posts[$i]['topic']['id'] ?>"> <span class="wow fadeInLeft red" data-wow-delay=".4s"> <?php echo $posts[$i]['topic']['name'] ?></span></a>
                </div>
              <?php endif ?>
              ...
              <div class="row mt-10 blog-btn-index">
                <div class="col-xl-8 col-lg-8 col-md-8">
                  <a href="<?php ROOT_PATH ?>/post/<?php echo $posts[$i]['slug']; ?>" class="theme-btn readmore-btn wow fadeInUp" data-wow-delay=".8s">Read more</a>
                </div>
