<section class="page-banner-section pt-30 pb-15 img-bg wow fadeInUp" data-wow-delay=".2s" style="background-image: url('assets/img/bg/common-bg.svg')">
  <div class="container">
    <div class="row">
      <div class="col-xl-12">
        <div class="banner-content">
          ...
          <div class="page-breadcrumb">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item wow fadeInLeft" data-wow-delay=".2s" aria-current="page"><a href="index.php">Cinemania</a></li>
                <?php if (isset($_GET['topic'])) : ?>
                  <li class="breadcrumb-item active  wow fadeInLeft" data-wow-delay=".4s"" aria-current=" page"><a href="blog.php">Blog</a></li>
                ...
                <?php elseif (isset($_GET['genre'])) : ?>
                  <li class="breadcrumb-item active  wow fadeInLeft" data-wow-delay=".4s"" aria-current=" page"><a href="reviews.php">Reviews</a></li>
