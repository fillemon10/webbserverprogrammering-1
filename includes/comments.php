        ...
        <div class="container box-style comment mb-10 mt-10 wow fadeInDown " data-wow-delay=".1s">
                ...
                <div class="col-xl-10 col-lg-10 col-md-10">
                    <div class="row">
                        <p class="comment-info wow fadeInDown " data-wow-delay=".1s">
                            <i class="p-mask lni lni-user"></i>&#8192;<?php echo $comment["username"];   ?>&#8192;&#8192;<i class="p-mask lni lni-calendar"></i>&#8192;<?php echo date("F j, Y ", strtotime($comment["created_at"])); ?>
                        </p>
                    </div>
            ...
            <div hidden class="container reply-form box-style mb-10 pb-15 pt-15">
                ...
                <div class="row">
                    ...
                    ?>
                    <form action="<?php echo $actual_link  ?>&reply-<?php echo $review_or_post ?>=<?php echo $comment['id'] ?>" method="POST">
                        <div class="form-group">
                                ...
                                <div class="col-xl-10 col-lg-10 col-md-10">
                                    <div class="row">
                                        <p class="wow fadeInDown comment-info" data-wow-delay=".1s">
                                            <i class="p-mask lni lni-user"></i>&#8192;<?php echo $reply["username"];   ?>&#8192;&#8192;<i class="p-mask lni lni-calendar"></i>&#8192;<?php echo date("F j, Y ", strtotime($reply["created_at"])); ?>
                                        </p>
                                    </div>
