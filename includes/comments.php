...
<div class="row mt-20">
    ...
    <form class="box-style mb-10 pb-20 mt-10 wow fadeInUp" action="" method="POST">
        ...
        <div class=" form-group">
            <textarea class="form-control box-style p-10  wow fadeInLeft" data-wow-delay="0.5s" name="comment_<?php echo $review_or_post ?>_text" rows="3" style="margin-top: 0px; margin-bottom: 0px; height: 138px;"></textarea>
        </div>
...
<script src="<?php ROOT_PATH ?>/assets/js/reply.js"></script>
